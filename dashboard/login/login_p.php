...
if (mysqli_num_rows($result_psychologist) > 0) {
    $psychologist_data = mysqli_fetch_assoc($result_psychologist);
    $_SESSION['psychologist_id'] = $psychologist_data['psychologist_id'];
    $_SESSION['full_name'] = $psychologist_data['full_name'];
